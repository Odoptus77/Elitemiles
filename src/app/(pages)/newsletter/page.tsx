      ...
      <div className="rounded-2xl border border-[color:var(--em-border)] bg-[color:var(--em-card)] p-6">
        <form onSubmit={onSubmit} className="grid gap-3 sm:grid-cols-[1fr_auto]">
          <input
            ...
            className="w-full rounded-xl border border-[color:var(--em-border)] bg-white px-4 py-3 text-sm text-[color:var(--em-fg)] placeholder:text-[color:var(--em-muted)] outline-none focus:border-[color:var(--em-gold)]/40"
          />
          <button
            type="submit"
